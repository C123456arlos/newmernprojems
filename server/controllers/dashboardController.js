...
export const getDashboard = async (req, res) => {
    try {
        ...
        if (session.role === 'ADMIN') {
            ...
            return res.json({
                role: 'ADMIN', totalEmployees, totalDepartments: DEPARTMENTS.length,
                todayAttendance,
                pendingLeaves
            })
        } else {
            ...
            const [currentMonthAttendance, pendingLeaves, latestPayslip] = await Promise.all([Attendance.countDocuments({
