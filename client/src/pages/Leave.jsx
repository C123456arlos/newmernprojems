...
import ApplyLeaveModel from "../components/leave/ApplyLeaveModal"
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        {!isAdmin && !isDeleted && (<button onClick={()=>setShowModal(true)} className="btn-primary flex items-center gap-2 w-full sm:w-auto justify-center">
      ...
      <LeaveHistory leaves={leaves} isAdmin={isAdmin} onUpdate={fetchLeaves}></LeaveHistory>
      <ApplyLeaveModal open={showModal} onClose={()=>setShowModal(false)} onSuccess={fetchLeaves}></ApplyLeaveModal>
    </div>
  )
}
